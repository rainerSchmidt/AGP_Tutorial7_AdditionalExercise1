...
float					g_fObjectDistance = 20.0;
float					g_fObjectPositionX = 0;
...
char		g_TutorialName[100] = "Tutorial 07 AdditionalExercise 01\0";
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYDOWN:
		...
		if (wParam == VK_RIGHT)
			g_pCamera->Strafe(g_fObjectDistance, g_fObjectPositionX, 5);
		if (wParam == VK_LEFT)
			g_pCamera->Strafe(g_fObjectDistance, g_fObjectPositionX, -5);
		if (wParam == VK_UP)
			g_pCamera->Forward(5);
...
HRESULT InitialiseGraphics()//03-01
{
	...
	g_pCamera = new Camera(5.0f, 0.0f, -0.5f, 0.0f);
	//g_pCamera->CalculateCameraRotation(g_fObjectDistance, g_fObjectPositionX);
...
void RenderFrame(void)
{
	...
	world *= XMMatrixTranslation(0.0f,0.0f,(g_fObjectDistance-10.0));
	...
	newWorld *= XMMatrixTranslation(0.0f,0.0f, (g_fObjectDistance + 10.0));
